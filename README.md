...
* `LayerNames` class attribute:
  * Provide strongly typed access to project layer names.
...
To use it, you have to declare a class with the `[InputMap]` attribute.
```cs
/// <summary>
...
### `LayerNames`
  * Class attribute
  * Provides strongly typed access to project layer names.
    

To use it, you have to delcare a class with the `[LayerNames]` attribute.
```cs
[LayerNames]
public static partial class LayerGen { }
```
The following code will be auto-generated by Source Genreator based on your project.

The layer names are declared in the `project.godot`.
```cs
// auto-generated code
partial class LayerGen
{
    public static class Render2D
    {
        public const int Layer1 = 0;
        public const uint Layer1_Mask = 1u << 0;
        public const int Layer2 = 1;
        public const uint Layer2_Mask = 1u << 1;
        public const int Layer7 = 6;
        public const uint Layer7_Mask = 1u << 6;
        public const int _11Layer = 10; // If the layer name starts with numbers, it adds '_'
        public const uint _11Layer_Mask = 1u << 10;
    }
    public static class Render3D
    {
        public const int Layer11 = 10;
        public const uint Layer11_Mask = 1u << 10;
        // ...
    }
    // ...Physics2D, Navigation2D, Physics3D, Navigation3D, and Avoidance classes.
}
```
