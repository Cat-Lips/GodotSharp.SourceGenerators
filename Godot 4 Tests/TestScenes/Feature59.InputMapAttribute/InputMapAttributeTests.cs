...
public partial class InputMapAttributeTests : Node, ITest
{
    void ITest.InitTests()
    {
        ...
        static void TestDefault()
        {
            ...
            MyInput.InvalidChars10.Should().Be((StringName)"'? - InvalidChars 10 ");
            MyInput.中文UnicodeChars11.Should().Be((StringName)"中文 - UnicodeChars 11 ");
            MyInput.中文.Combined12.Should().Be((StringName)"中文 . '? - Combined 12 ");
            ...
            MyStaticInput.InvalidChars10.Should().Be((StringName)"'? - InvalidChars 10 ");
            MyStaticInput.中文UnicodeChars11.Should().Be((StringName)"中文 - UnicodeChars 11 ");
            MyStaticInput.中文.Combined12.Should().Be((StringName)"中文 . '? - Combined 12 ");
        ...
        static void TestCustom()
        {
            ...
            MyGameInput.InvalidChars10.Action.Should().Be((StringName)"'? - InvalidChars 10 ");
            MyGameInput.中文UnicodeChars11.Action.Should().Be((StringName)"中文 - UnicodeChars 11 ");
            MyGameInput.中文.Combined12.Action.Should().Be((StringName)"中文 . '? - Combined 12 ");
            ...
            MyStaticGameInput.InvalidChars10.Action.Should().Be((StringName)"'? - InvalidChars 10 ");
            MyStaticGameInput.中文UnicodeChars11.Action.Should().Be((StringName)"中文 - UnicodeChars 11 ");
            MyStaticGameInput.中文.Combined12.Action.Should().Be((StringName)"中文 . '? - Combined 12 ");
        ...
        static void TestInput()
        {
            ...
            TestInput(MyGameInput.InvalidChars10);
            TestInput(MyGameInput.中文UnicodeChars11);
            TestInput(MyGameInput.中文.Combined12);
            ...
            //TestInput(MyStaticGameInput.InvalidChars10);
            //TestInput(MyStaticGameInput.中文UnicodeChars11);
            //TestInput(MyStaticGameInput.中文.Combined12);
