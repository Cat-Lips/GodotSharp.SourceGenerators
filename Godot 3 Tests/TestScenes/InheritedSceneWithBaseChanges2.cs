...
{
    [SceneTree]
    internal abstract partial class InheritedSceneWithBaseChanges2 : InheritedScene, ITest
    {
        void ITest.InitTests()
        {
            ...
            _.Layout.Layout.Label2.GetType().Should().Be(typeof(InheritedSceneTypeOverride));
